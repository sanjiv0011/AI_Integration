...
public class BaseClass {
	...
	@BeforeTest
	public void browserSettingAndLoginLogout(ITestContext context) {
	...
	@Parameters("browser")
	@BeforeTest(dependsOnMethods = "browserSettingAndLoginLogout")
	public void Setup(String br) throws InterruptedException {
		...
		if (br.equalsIgnoreCase("chrome")) {
			...
			driver = new ChromeDriver(cco.customizedChromeOptions(wantToBlockAdsAndNotifications, headerLessBrowsing,
					incognitoMode, wantToEnableDebuggerMode, debuggerPort));
